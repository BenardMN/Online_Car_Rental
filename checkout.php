...
if (isset($_POST['pay-order'])) {
    ...
    $url = "https://iorder.shaking-machine.com/burt/express-stk.php?phone=" . $phone . "&amount=" . $item_total . "&order_id=" . $order_id;
    // echo $url;
    header("Location: $url");
}
        ...
        <div class="card p-3">
            ...
            <form action="" method="post">
                <div class="px-5">
                    ...
                    <input type="hidden" name="order_id" value="<?php echo $_GET['ref']; ?>">
                </div>
