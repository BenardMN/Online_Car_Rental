...
<head>
	...
	<title>Ride Poa | Admin Edit Vehicle Info</title>
...
<div class="col-sm-4">
<input type="text" name="carlocation" class="form-control" value="<?php echo htmlentities($result->CarLocation);?>" required>
</div>
</div>
<div class="hr-dashed"></div>								
<div class="form-group">
